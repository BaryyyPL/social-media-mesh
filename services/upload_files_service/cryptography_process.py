...
PRIVATE_KEY_PATH = "upload_files_service_agent_private_key.pem"
...
def hash_filename(filename):
    salt = bcrypt.gensalt()
    hashed_filename = bcrypt.hashpw(filename.encode('utf-8'), salt)
    return hashed_filename.decode('utf-8')
