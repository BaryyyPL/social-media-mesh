...
PRIVATE_KEY_PATH = "delete_account_service_agent_private_key.pem"
...
def handshake_receiver(public_key, private_key, manager_public_key, manager_socket):
    ...
    if received_message['request_code'] == '101':
        ...
        if (received_message['request_code'] == '101'
            ...
            symmetrical_key = private_key_decrypt(private_key,
                                                  base64_decode(received_message['encrypted_symmetrical_key']))
            signed_symmetrical_key = symmetric_key_decrypt(symmetrical_key,
                                                           base64_decode(
                                                               received_message['encrypted_signed_symmetrical_key']))
